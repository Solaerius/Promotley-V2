...
-- Drop all existing policies and recreate with proper granularity
...
DROP POLICY IF EXISTS "Authenticated users cannot modify rate limits" ON public.rate_limits;
...
-- This prevents users from manipulating rate limit data to bypass protections

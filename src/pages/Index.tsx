...
const Index = () => {
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      {/* Seamless gradient flow container */}
      <div className="relative">
        {/* Global mesh overlay for seamless blending */}
        <div className="mesh-blend fixed inset-0 pointer-events-none" style={{ zIndex: 0 }} />
        
        {/* Hero flows into Problem */}
        <Hero />
        
        {/* Fluid transition overlay */}
        <div className="relative" style={{ marginTop: '-100px', paddingTop: '100px' }}>
          <AnimatedSection animation="blur-in">
            <ProblemSection />
          </AnimatedSection>
        </div>
        
        {/* Problem flows into HowItWorks */}
        <div className="relative" style={{ marginTop: '-80px', paddingTop: '80px' }}>
          <AnimatedSection animation="blur-in" delay={100}>
            <HowItWorks />
          </AnimatedSection>
        </div>
        
        {/* HowItWorks flows into Results */}
        <div className="relative" style={{ marginTop: '-80px', paddingTop: '80px' }}>
          <ResultsSection />
        </div>
        
        {/* Results flows into AIDemo */}
        <div className="relative" style={{ marginTop: '-80px', paddingTop: '80px' }}>
          <AnimatedSection animation="blur-in" delay={100}>
            <AIDemoSection />
          </AnimatedSection>
        ...
        {/* Pricing flows into Testimonials */}
        <div className="relative" style={{ marginTop: '-80px', paddingTop: '80px' }}>
          <AnimatedSection animation="blur-in">
            <Testimonials />
          </AnimatedSection>
      ...
      <footer className="relative border-t border-white/10 py-10 md:py-12 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-diagonal" />
        <div className="container mx-auto text-white/60 font-poppins relative z-10">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto mb-6 md:mb-8">
            {/* Company Info */}
            <div className="text-center sm:text-left">
              <h3 className="font-bold text-white mb-2 md:mb-3">Promotley UF</h3>
            ...
            {/* Contact */}
            <div className="text-center sm:text-left">
              <h3 className="font-bold text-white mb-2 md:mb-3">Kontakt</h3>
              <div className="space-y-1.5 md:space-y-2 text-xs md:text-sm">
                <div>
                  <a href="mailto:uf@promotley.se" className="hover:text-white transition-colors">
                    uf@promotley.se
                  </a>
                </div>
                <div>
            ...
            <div className="text-center sm:text-left md:text-right sm:col-span-2 md:col-span-1">
              <h3 className="font-bold text-white mb-2 md:mb-3">Länkar</h3>
              <div className="space-y-1.5 md:space-y-2 text-xs md:text-sm">
                <div>
          ...
          {/* Copyright */}
          <div className="text-center text-xs md:text-sm pt-5 md:pt-6 border-t border-white/10">
